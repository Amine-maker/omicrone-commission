...
<form action="index.php?uc=cra&action=update" method="post">
...
?>
   ...
   <tr>
    ...
    <td colspan="<?php echo $number; ?>" style="border:2px solid;"><textarea placeholder="Décrire les intervention" style="width:100%;" rows="4"  name="intervention"></textarea></td>
   </tr>
