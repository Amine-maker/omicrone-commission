...
$data.='<div>';
$data.=' <img src="logo/omicrone.jpg" width="200" style="float:right;" />';
$data.='</div>';


$data.='<div style="float:left;">';
$data.='<h3 style="margin-top:-100px;"> Periode : <u> '. getMoisFr($mois).'</u> '.$annee ."&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Intervenant : <u>". $consultant->getNom()." ".$consultant->getPrenom() .'</u>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; Client : <u>' . $nomClient .'</u></h3>';
$data.='</div>';
...
$data.='   <td colspan='. $number.' style="border:2px solid;"><textarea style="width:100%;height:5%;">'.$_POST["astreinte"] .'</textarea></td>
        </tr>';

$data.=' <tr>';
$data.='  <td style="border:2px solid;">Intervention</td>';
$data.='   <td colspan='. $number.' style="border:2px solid;"><textarea style="width:100%;height:4%;">'.$_POST["intervention"] .'</textarea></td>
        </tr>';
        ...
        $data.='  <div style="background-color: white;
                ...
                padding: 20px;
                ">
                 <h3 style="color:red;margin-left:20%;float:left;margin-top:-15px;">Client&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Prestataire</h3>
                    <br>
