...
class craDAO{
    ...
    public function add($cra){
        ...
        $intervention=$cra->getIntervention();
    ...
    public function collectionCRA(){
        ...
        for ($i=0; $i<=count($lesCras)-1; $i++) {
                ...
                $objcra = new cra ($lesCras[$i]['totaljfacturable'], $lesCras[$i]['totaljmaladie'],$lesCras[$i]['totaljconge'], $objcontrat, $lesCras[$i]['astreinte'],$lesCras[$i]['intervention'], $lesCras[$i]['periode']);
                $collection[]=$objcra;
            } 
            return $collection;
    }
    ...
    public function getcraformid($idcra){ //retourne un objet cra en fonction de son id 
        ...
        $cra = new cra ($uncra->totaljfacturable, $uncra->totaljmaladie, $uncra->totaljconge, $uncra->astreinte,$uncra->intervention, $uncra->idcontrat, $uncra->periode);
         return $cra;
    }
